...
const PropertyForm = ({ packageId }: { packageId: string }) => {
    ...
    const citiesForRegion = ETHIOPIA_REGIONS.find(
...
async function onSubmit(values: z.infer<typeof createPropertySchema>) {
    ...
    const removePreview = useCallback(
        ...
        if (type === "regular") {
            ...
            const newFiles = form.getValues("images")?.filter((_, i) => i !== index) || [];
...
const onDropRegular = useCallback(
  ...
  return (
    <div className="flex justify-center bg-neutral-50 p-8 rounded-2xl border-1 shadow-2xl">
        <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 w-[70vw]">
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription className="text-xs">
                  The total area of all floors within the house, measured from the inside walls
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription className="text-xs">
                  The total area of the land on which the house is constructed including the compound
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
              ...
              <FormItem>
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem className="cursor-pointer" value="House">House</SelectItem>
                    <SelectItem className="cursor-pointer" value="Commercial">Commercial</SelectItem>
                    <SelectItem className="cursor-pointer" value="Land">Land</SelectItem>
              ...
              <FormItem>
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value} disabled>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem className="cursor-pointer" value="sold">Sold</SelectItem>
                    <SelectItem className="cursor-pointer" value="rented">Rented</SelectItem>
                  </SelectContent>
                </Select>
                <FormMessage />
              </FormItem>
                  ...
                  <Select onValueChange={field.onChange} value={field.value}>
                    ...
                    <SelectContent>
                      {ETHIOPIA_REGIONS.map((region) => (
                        <SelectItem className="cursor-pointer" key={region.name} value={region.name}>
                          {region.name}
                        </SelectItem>
                      ))}
                    </SelectContent>
                  ...
                  >
                    ...
                    <SelectContent>
                      {citiesForRegion.map((city) => (
                        <SelectItem className="cursor-pointer" key={city} value={city}>
                          {city}
                        </SelectItem>
                      ))}
                    </SelectContent>
              ...
              <FormItem>
                ...
                <FormControl>
                  ...
                  >
                    ...
                    {isRegularDragActive ? (
                      <p className="text-blue-500">Drop regular images here...</p>
                    ) : (
                      <div>
              ...
              <FormItem>
                ...
                <FormControl>
                  ...
                  >
                    ...
                    {isPanoramicDragActive ? (
                      <p className="text-purple-500">Drop panoramic images here...</p>
                    ) : (
                      <div>
                        <p className="text-gray-500">
