  ...
  const properties: Property[] = [
    {
      ...
      description: "Stunning modern villa with panoramic ocean views and private beach access.",
      price: 4250000,
      beds: 5,
      baths: 4.5,
      areaSqft: 5800,
    ...
    },
    {
      ...
      description: "Industrial-chic loft in the heart of the city with rooftop access.",
      price: 1850000,
      beds: 3,
      baths: 2,
      areaSqft: 3200,
    ...
    },
    {
      ...
      description: "Cozy log cabin nestled in the mountains with breathtaking views.",
      price: 950000,
      beds: 4,
      baths: 3,
      areaSqft: 2800,
