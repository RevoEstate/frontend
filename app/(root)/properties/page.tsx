...
// Mock filter states (replace with real state management)
  ...
  return (
    <div className="container py-8 mt-18">
      ...
      <div className="mb-12 text-center">
        <h1 className="text-4xl font-bold tracking-tight mb-4">Find Your Dream Property</h1>
      ...
      <div className="bg-background p-6 rounded-lg shadow-sm mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-5"> {/* Changed to 5 columns */}
  {/* Price Range Filter */}
  <div className="mr-5">
  ...
  <div>
    ...
    >
      ...
      <SelectContent>
        ...
        <SelectItem value="Los Angeles" className="cursor-pointer">Los Angeles</SelectItem>
        <SelectItem value="Chicago" className="cursor-pointer">Chicago</SelectItem>
        <SelectItem value="Miami" className="cursor-pointer">Miami</SelectItem>
        <SelectItem value="Houston" className="cursor-pointer">Houston</SelectItem>
      </SelectContent>
    </Select>
  </div>
  ...
  <div>
    ...
    <Select value={propertyType} onValueChange={setPropertyType}>
      ...
      <SelectContent>
        ...
        <SelectItem value="For Sale" className="cursor-pointer">For Sale</SelectItem>
        <SelectItem value="For Rent" className="cursor-pointer">For Rent</SelectItem>
      </SelectContent>
    </Select>
  </div>
  ...
  <div>
    ...
    >
      <ToggleGroupItem value="any" className="text-xs rounded-full cursor-pointer">
        Any
      </ToggleGroupItem>
      <ToggleGroupItem value="1" className="text-xs rounded-full cursor-pointer">
        1+
      </ToggleGroupItem>
      <ToggleGroupItem value="2" className="text-xs rounded-full cursor-pointer">
        2+
      </ToggleGroupItem>
      <ToggleGroupItem value="3" className="text-xs rounded-full cursor-pointer">
        3+
      </ToggleGroupItem>
      <ToggleGroupItem value="4" className="text-xs rounded-full cursor-pointer">
        4+
      </ToggleGroupItem>
      <ToggleGroupItem value="5" className="text-xs rounded-full cursor-pointer">
        5+
      </ToggleGroupItem>
    </ToggleGroup>
  </div>
  ...
  {/* Reset Filters */}
  <div className="flex items-end col-span-1 md:col-span-5 md:col-start-5 mt-5"> {/* Span all columns on mobile */}
    <Button
      variant="outline"
