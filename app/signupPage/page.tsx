...
export default function SignupPage() {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: "url('/images/luxury-house.png')" }}
    >
      ...
      {!selectedType ? (
        ...
        <Card className="w-full max-w-md bg-white/80 backdrop-blur-sm border-0 shadow-lg relative z-10">
          <CardHeader>
            <Button variant="ghost" className="absolute left-2 top-2 p-2" onClick={() => setSelectedType(null)}>
              ← Back
            </Button>
            <CardTitle className="text-2xl font-bold text-center pt-4">Company Registration</CardTitle>
            <CardDescription className="text-center">Create your real estate company account</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="w-full max-w-md bg-white/80 backdrop-blur-sm border-0 shadow-lg relative z-10">
          <CardHeader>
            ...
            <CardTitle className="text-2xl font-bold text-center pt-4">Client Registration</CardTitle>
            <CardDescription className="text-center">Create your client account</CardDescription>
          </CardHeader>
          <CardContent>
