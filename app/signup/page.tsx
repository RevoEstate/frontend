...
export default function SignupPage() {
  ...
  const [selectedType, setSelectedType] = useState<"company" | "client" | null>(
    null
  );
  ...
  const handleClientSignup = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      router.push("/Dashboard"); // Changed from "/" to "/dashboard" to direct clients to dashboard too
    }, 1500);
  };
            ...
            <form onSubmit={handleCompanySignup} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="company-email"
                  type="email"
                  placeholder="contact@acmerealestate.com"
                  required
                />
              </div>
              <div className="space-y-2">
