...
export default async function PackageDetailPage ({
    ...
    try {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_ENDPOINT}/api/v1/system-admin/getpackage/${id}`, 
        {
            method: 'GET',
            credentials: 'include'
        }
        ...
        const { data } = await res.json() as { data: IPackage }
        ...
        console.error("Error in package detail page", error)
        redirect('/realestate/packages')
    }
}